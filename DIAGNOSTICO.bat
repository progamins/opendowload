...
netstat -ano | findstr ":3001" >nul && echo [OCUPADO] Puerto 3001 || echo [LIBRE] Puerto 3001
curl -s http://127.0.0.1:3001/health >nul 2>&1 && (echo [OK] API health & curl -s http://127.0.0.1:3001/health) || echo [OFF] API no responde
